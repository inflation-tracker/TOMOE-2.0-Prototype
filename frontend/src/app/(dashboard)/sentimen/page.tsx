...
import { mockSentimentSummary, mockSentimentFeed, mockSentimentTimeline } from '@/lib/mock-data'
...
export default function SentimenPage() {
  const timeline = mockSentimentTimeline.slice(-14)
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
        ...
        <div className="h-52">
          <InflationLineChart
            ...
            lines={[
              { key: 'neg', label: 'Negatif', color: '#ef4444' },
              { key: 'pos', label: 'Positif', color: '#22a05a' },
            ]}
            xKey="time"
            yFormatter={(v) => v + '%'}
          />
